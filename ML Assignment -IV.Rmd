---
title: "Machine Learning Assignment-IV"
author: "Pradhap P"
date: "2022-10-18"
...
```
  ...
  Ans:- Here we use for loop and check thee value for all values column is true and the error row value has changed to 0 and 1 by refer it as true or false.
